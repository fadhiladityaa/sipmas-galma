    ...
    <div class="content font">
        ...
        <table style="margin-left: 20px;">
            <tr>
                ...
                <td style="padding: 2px 0;">{{ $pejabat['nama'] ?? 'MUHAMMAD ZULKIFLI FARID, SE' }}
                </td>
            </tr>
            <tr>
        ...
        <p style="margin-top: 7px;">dengan ini menerangkan bahwa:</p>

        <!-- Data Pemohon (poin a, b, c, ...) dalam TABEL -->
        <table style="margin-left: 20px; border-collapse: collapse;">
            <tr>
                <td style="width: 55px; padding: 2px 0;">a. Nama</td>
                <td style="width: 10px; padding: 2px 0;">:</td>
                <td style="padding: 2px 0;">{{ $user->name }}</td>
            </tr>
            <tr>
                <td style="padding: 2px 0;">b. NIK</td>
                <td style="padding: 2px 0;">:</td>
                <td style="padding: 2px 0;">{{ $user->nik ?? '-' }}</td>
            </tr>
            <tr>
                <td style="padding: 2px 0; width: 180px">c. Tempat/Tanggal Lahir</td>
                <td style="padding: 2px 0;">:</td>
                <td style="padding: 2px 0;">{{ $user->tempat_lahir ?? '-' }},
                    {{ $user->tanggal_lahir ? \Carbon\Carbon::parse($user->tanggal_lahir)->format('d F Y') : '-' }}</td>
            </tr>
            <tr>
                <td style="padding: 2px 0;">d. Umur</td>
                <td style="padding: 2px 0;">:</td>
                <td style="padding: 2px 0;">
                    {{ $user->tanggal_lahir ? \Carbon\Carbon::parse($user->tanggal_lahir)->age . ' Tahun' : '-' }}</td>
            </tr>
            <tr>
                <td style="padding: 2px 0;">e. Kebangsaan</td>
                <td style="padding: 2px 0;">:</td>
                <td style="padding: 2px 0;">Indonesia</td>
            </tr>
            <tr>
                <td style="padding: 2px 0;">f. Agama</td>
                <td style="padding: 2px 0;">:</td>
                <td style="padding: 2px 0;">{{ $user->agama ?? '-' }}</td>
            </tr>
            <tr>
                <td style="padding: 2px 0;">g. Pekerjaan</td>
                <td style="padding: 2px 0;">:</td>
                <td style="padding: 2px 0;">{{ $user->pekerjaan ?? '-' }}</td>
            </tr>
            <tr>
                <td style="padding: 2px 0;">h. Alamat</td>
                <td style="padding: 2px 0;">:</td>
